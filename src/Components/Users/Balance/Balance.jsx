                ...
                {loading ? <Loading/> : <>
                {
                    ...
                    <div className='container mx-auto grid grid-cols-12'>
                        {method?.length > 0 ?
                            ...
                            method.map(item => {
                                return(
                                    <button className='lg:col-span-2 md:col-span-3 col-span-12 p-1 px-2 border-2 rounded-lg border-green-700 text-green-700 hover:text-white hover:bg-green-700 font-bold uppercase' key={item}><i className={item === "Paypal" ? 'fab fa-paypal' : ""}></i> {item}</button>
                                )
                            })
