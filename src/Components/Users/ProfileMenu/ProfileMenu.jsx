        ...
        <>
            <div className="col-span-4 border-2 border-gray-400 rounded-xl p-3 md:block hidden">
                ...
                <ul className='ml-5 mb-2'>
                    ...
                    <li className={active?.passwordSecurity ? 'text-green-600 cursor-pointer text-lg mb-2' : 'cursor-pointer text-lg mb-2'}>Password & Security</li>
                </ul>
                <h5 className='text-xl mb-2'><b>Payments</b></h5>
                <ul className='ml-5 mb-2'>
                    <li className={active?.payments ? 'text-green-600 cursor-pointer text-lg mb-2' : 'cursor-pointer text-lg mb-2'}>Payments</li>
                ...
                <ul className='ml-5 mb-2'>
                    <li className={active?.manageNotification ? 'text-green-600 cursor-pointer text-lg mb-2' : 'cursor-pointer text-lg mb-2'}>Manage Notifications</li>
                </ul>
                <h5 className='text-xl mb-2'><b>Manage Account</b></h5>
                <ul className='ml-5'>
                    <li className={active?.deleteAccount ? 'text-green-600 cursor-pointer text-lg mb-2' : 'cursor-pointer text-lg mb-2'}>Delete Account</li>
