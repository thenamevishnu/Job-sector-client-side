    ...
    return (
      ...
      <div className='Header'>
          <div className='logo'>
              ...
              {icons && <div className='ms-5 d-md-inline d-none'>
                <ul className='list-inline'>
                    ...
                    {type === "freelancer" && <li className='me-3 list-inline-item cursor-pointer'>My Jobs</li>}
                    {type === "client" && <li className='me-3 list-inline-item cursor-pointer' onClick={()=>navigate("/my-posts")}>My Posts</li>}
          ...
          {icons && <div className='icons'>
                ...
                <i className='far fa-question me-3 cursor-pointer'></i>
                <i className='far fa-comment-dots me-3 cursor-pointer'></i>
                <i className='far fa-bell me-3 cursor-pointer'></i>
